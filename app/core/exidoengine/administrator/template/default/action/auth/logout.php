...
$msg = sprintf(__("You're successfully logged out. %s to log in again."), '<a href="/">'.__('Click here').'</a>');
...
$helper
  ...
  ->openHead()
  ->base()
  ->title(__("You're successfully logged out"))
  ->charset()
  ->fav('exidoengine')
  ->css('exido-bootstrap/bootstrap')
  ->css('exido-bootstrap/bootstrap-green')
  ->css('administrator/forbidden')
  ->closeHead()
  ->openBody()
  ->open('wrapper', 'wrapper')
  ->open('container')
  ->notifier($msg, 'messages')
  ->close()
  ->close()
