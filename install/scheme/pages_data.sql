...
VALUES (100           ,'title'        ,'varchar'      ,NOW()       ,'eav/eavFormInput','Page title' ,'1'        ,'1');
...
INSERT INTO `page_attribute`
       (`attribute_id`,`attribute_key`,`data_type_key`,`created_at`,`is_system`,`default_value`,`is_required`)
VALUES (103           ,'created_at'   ,'datetime'     ,NOW()       ,'1'        ,'NOW()'        ,'1');

INSERT INTO `page_attribute`
       (`attribute_id`,`attribute_key`,`data_type_key`,`created_at`,`is_system`,`default_value`,`is_required`)
VALUES (104           ,'updated_at'   ,'datetime'     ,NOW()       ,'1'        ,'NOW()'        ,'1');
...
INSERT INTO `page_attribute`
       (`attribute_id`,`attribute_key`,`data_type_key`,`created_at`,`is_system`)
...
INSERT INTO `page_attribute`
       (`attribute_id`,`attribute_key`,`data_type_key`,`created_at`,`backend_object`  ,`description`,`is_system`,`is_required`)
VALUES (115           ,'urlpath'      ,'varchar'      ,NOW()       ,'eav/eavFormInput','URL key'    ,'1'        ,'1');
