...
?>
<div class="error" style="font: 1em sans-serif; text-align: left;"><?php echo sprintf(self::$php_errors[$errno].' [ %s ]: %s ~ %s [ %d ]', $errno, strip_tags($errstr), Debug::path($errfile), $errline);?></div>
