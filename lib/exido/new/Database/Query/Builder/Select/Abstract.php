...
/**
 * Abstract database query builder - Select version.
 * @package    core
 * @subpackage database
 ...
 * @version    1.0
 */
abstract class Exido_Database_Query_Builder_Select_Abstract extends Exido_Database_Query_Builder_Abstract
{
  protected $_order_by;
