...
final class Database_Query_Builder
{
  ...
  {
    $db = new Exido_Database_Query_Builder_Update($table, $this->config_scope, $this->config);
    $db->setFields($aData);
    return $db;
  }
  ...
  {
    $db = new Exido_Database_Query_Builder_Select($table, $this->config_scope, $this->config);
    $db->setFields($aData);
    return $db;
  }
  ...
  {
    $db = new Exido_Database_Query_Builder_Insert($table, false, $this->config_scope, $this->config);
  ...
  {
    $db = new Exido_Database_Query_Builder_Insert($table, true, $this->config_scope, $this->config);
    $db->setInsertFields($aData);
    return $db;
  }
  ...
  {
    return new Exido_Database_Query_Builder_Delete($table, $this->config_scope, $this->config);
  }
  ...
  {
    $db = new Exido_Database_Query_Builder_Custom($this->config_scope, $this->config);
  ...
  {
    $db = new Exido_Database_Query_Builder_Service($this->config_scope, $this->config);
