 ...
 * @version    1.0
 */
class Exido_Database_Cache_Read extends Exido_Database_Cache implements Exido_Database_Interface_Cache_Read
{
  /**
   * Constructor.  Sets the cache folder, life time and encodes the query hash.
   * @param Exido_Database_Adapter $adapter
   */
  public function __construct(Exido_Database_Adapter $adapter)
  {
