 ...
 * @version    1.0
 */
abstract class Exido_Database_Adapter implements Exido_Database_Interface_Adapter//, Database_Interface_QueryBuiler
{
  public $type;
  public $pconnect;
  ...
  public function exec($sql, $cache_lifetime = null, $no_cache = false)
  {
    ...
    if($this->cache_enabled) {
      ...
      $cache = new Exido_Database_Cache_Read($this);
    }
    ...
    $driver            = 'Exido_Database_Driver_'.ucfirst($this->type).'_Result';
    $result            = new $driver();
