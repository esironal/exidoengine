...
include_once 'View/Helper/Abstract/Library.php';
include_once 'View/Helper/Abstract/Meta.php';
include_once 'View/Helper/Abstract/Html.php';
include_once 'View/Helper/Abstract.php';
 ...
 * @version    1.0
 */
class Exido_View_Core extends Exido_View_Abstract
{
  /**
   * Dynamic javascript
   * @var
