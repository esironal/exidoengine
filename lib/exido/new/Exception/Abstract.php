...
include_once 'Exception/403.php';
include_once 'Exception/404.php';

/**
 * Abstract exido exception class.
 * @package    core
 ...
 * @version    1.0
 */
abstract class Exido_Exception_Abstract extends Exception
{
  ...
  public static function handlerException($e)
  {
    try {
      ...
      if(IN_PRODUCTION == true) {
        if($e instanceof Exido_Database_Exception) {
          exit($message);
        } else {
          $view          = View::instance();
          $view->code    = $code;
